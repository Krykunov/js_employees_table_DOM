...
init();
const currencyFormat = (number)=>"$" + new Intl.NumberFormat("en-US").format(number);
...
headers.forEach((header, i)=>{
    header.addEventListener("click", (e)=>{
        ...
        rows.sort((a, b)=>{
            ...
            if (Number(checkNumberCellA)) return ASC ? checkNumberCellA - checkNumberCellB : checkNumberCellB - checkNumberCellA;
...
const createForm = (fields)=>{
    ...
    for(const key in fields)if (fields[key]) {
